...
const UpdateModulePage: React.FC = () => {
    ...
    const fetchModule = async () => {
      try {
        ...
        setForm({
          ...
          studentCredits: apiMod.studentCredits ?? 0,
  ...
  const validateStudentCredits = (v: number) => (isNaN(v) || v <= 0 ? "Vul geldige studiepunten in" : "");
  const validateLanguage = (v: string) => (!languages.includes(v) ? "Kies een geldige taal" : "");

  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    const { name, value } = e.target;
    setForm({ ...form, [name]: name === "studentCredits" ? Number(value) : value });
    if (error) setError("");
  };
  ...
  try {
    ...
    const res = await fetch(url, {
      ...
      body: JSON.stringify({
        ...
        period: form.period,
        studentCredits: form.studentCredits,
    ...
    <div className="d-flex justify-content-center align-items-center">
      <div className="card p-4 custom-shadow" style={{ width: "500px" }}>
        ...
        <form noValidate onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label htmlFor="location" className="form-label">Locatie:</label>
            <input
              type="text"
              id="location"
              name="location"
          ...
          <div className="mb-3">
            <label htmlFor="period" className="form-label">Periode:</label>
            <select
              id="period"
              name="period"
          ...
          <div className="mb-3">
            <label htmlFor="studentCredits" className="form-label">Studiepunten:</label>
            <input
              type="number"
              id="studentCredits"
              name="studentCredits"
          ...
          <div className="mb-3">
            <label htmlFor="language" className="form-label">Taal:</label>
            <select
              id="language"
              name="language"
